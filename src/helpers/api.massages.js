...
export default {
    ...
    findOne: 'Successfully find one.',
    findAll: 'Successfully find All.',
    exists: 'Already exists data!',
    fileUploadError: 'You must select a file.',
    validation: 'Validation Error! Please try again later.',
    ...
    forgetPasswordMobile: 'An OTP is sent to the registered mobile. Please use that OTP to access your account.',
